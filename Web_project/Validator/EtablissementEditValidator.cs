...
{
    public class EtablissementEditValidator : AbstractValidator<EtablissementEditViewModel>
    {
        AllValidation oValidation = new AllValidation();
        private readonly IVatLayerRepository vatValidator;

        public EtablissementEditValidator(IVatLayerRepository vatValidator)
        {
